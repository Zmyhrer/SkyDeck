...
const Header = ({ onSidebarToggle }: { onSidebarToggle: () => void }) => {
  ...
  return (
    <header className="w-full bg-gray-800 z-50 text-white shadow-md">
  <div className="w-full flex items-center justify-between p-4">
    ...
    <Link
      href="/dashboard"
      className="text-xl font-bold md:text-2xl hover:text-gray-300 transition-colors"
    >
    ...
    {/* User/Profile or Auth Buttons (right) */}
    {user ? (
      <Link
        href="/profile"
