...
#User - Update
@weather_router.put("/User/Update/{user_id}")
...
#User - Delete
@weather_router.delete("/deleteUser/{user_id}")
...
#Deck - Create
@weather_router.post("/Deck/Create")
...
#Deck - Update
@weather_router.put("/Deck/Update/{deck_id}")
...
#Deck - Delete
@weather_router.delete("/Deck/Delete/{deck_id}")
...
#Element - Create
@weather_router.post("/Element/Create")
...
#Element - Update
@weather_router.put("/Element/Update")
...
#Element - Delete
@weather_router.delete("/Element/Delete")
